...
const Content = () => {
	return (
		<div className="content pt-5">
			...
			<div className="row">
				<div className="col-8 main-content">
					...
					<div className="row pt-5">
						<div className="col-6 main-title"><h1>The Bright Future of Web 3.0?</h1></div>
						<div className="col-6 main-paragraph">
				...
				<div className="col-4 side-contents">
					<h1>New</h1>
			...
			<div className="row pt-5 sub-contents mt-4">
				<div className="col-4">
					<div className="row">
